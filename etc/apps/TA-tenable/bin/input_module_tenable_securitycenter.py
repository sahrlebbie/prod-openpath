...
def validate_input(helper, definition):
    ...
    validate_sync_plugins(helper, sync_plugins, "tenable_securitycenter://",
                          account_conf, account_stanza, input_parser_obj,
                          input_stanzas, name)
...
def collect_events(helper, ew):
    ...
    ingester = SCCollector(helper, ew, analysis_type="sc_vuln")
