...
# Now let's actually apply that baseline
	...
	if addAllfields:
		...
		myFields = ["usecase", "category", "domain", "data_source_categories", "data_source_categories_display", "mitre_tactic", "mitre_tactic_display", "mitre_technique", "mitre_technique_display", "mitre_matrix", "mitre_threat_groups", "killchain", "alertvolume"]
