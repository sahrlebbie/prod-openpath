...
require(["jquery",
    ...
    function(
            ...
            (function setupOutliersVizSearch() {
                ...
                function scheduleAlert() {
                    ...
                    require(["components/data/sendTelemetry", 'json!' + $C['SPLUNKD_PATH'] + '/servicesNS/nobody/Splunk_Security_Essentials/storage/collections/data/sse_app_config'], function(Telemetry, appConfig) {
                        let record = { "status": "scheduleAlertStarted", "searchName": currentSampleSearch.label }
                ...
                function scheduleHighCardinalityAlert() {
                    ...
                    require(["components/data/sendTelemetry", 'json!' + $C['SPLUNKD_PATH'] + '/servicesNS/nobody/Splunk_Security_Essentials/storage/collections/data/sse_app_config'], function(Telemetry, appConfig) {
                        let record = { "status": "scheduleAlertStarted", "type": "highCardinality", "searchName": currentSampleSearch.label }
                        for(let i = 0; i < appConfig.length; i++){
                            if(appConfig[i].param == "demoMode" && appConfig[i].value == "true"){
                                 record.demoMode = true
                            }
                                    ...
                                    if (isValid) {
                                        ...
                                        alertModal.model.alert.onComplete = function(properties) {
                                            ...
                                            secondAlertModal.model.alert.onComplete = function() {
                                                ...
                                                require(["components/data/sendTelemetry", 'json!' + $C['SPLUNKD_PATH'] + '/servicesNS/nobody/Splunk_Security_Essentials/storage/collections/data/sse_app_config'], function(Telemetry, appConfig) {
                                                    let record = { "status": "scheduleAlertCompleted", "type": "highCardinality", "searchName": currentSampleSearch.label }
                                                    for(let i = 0; i < appConfig.length; i++){
                                                        if(appConfig[i].param == "demoMode" && appConfig[i].value == "true"){
                                                             record.demoMode = true
                                                        }
        ...
        var ModifiedLaunchQuerySPL = function(modalName, modalTitle, vizQueryArray, vizQueryComments, baseTimerange, vizOptions) {
            ...
            require(["components/data/sendTelemetry", 'json!' + $C['SPLUNKD_PATH'] + '/servicesNS/nobody/Splunk_Security_Essentials/storage/collections/data/sse_app_config'], function(Telemetry, appConfig) {
                let record = { "status": "SPLViewed", "searchName": currentSampleSearch.label }
                for(let i = 0; i < appConfig.length; i++){
                    if(appConfig[i].param == "demoMode" && appConfig[i].value == "true"){
                         record.demoMode = true
                    }
        ...
        setTimeout(function() {
            //$("button:contains(Line-by-Line SPL Documentation)").first().after("<button class=\"btn btn-default mlts-show-spl\" id=\"highCardinalityExternal\">High Cardinality / High Scale Alert Disabled for Splunk 7 (Working on Fix)</button>");
