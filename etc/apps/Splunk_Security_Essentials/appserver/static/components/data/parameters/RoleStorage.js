...
define(['json!' + $C['SPLUNKD_PATH'] + '/services/SSEShowcaseInfo?fields=mini&locale=' + window.localeString, 'splunkjs/mvc/simplexml/controller', 'Options'], function(ShowcaseInfo, DashboardController, Options) {
