        ...
        build_tile: function build_tile(showcaseSettings, forSearchBuilder, showcaseName) {
            ...
            if (showcaseSettings.data_source_categories) {
                ...
                for(let i = 0; i < dscs.length; i++){
                    ...
                    datasourceText += "<div title=\"\"  class=\"contentstooltipcontainer datasourceElements\"><a target=\"_blank\" href=\"data_inventory#id=" + dsc + "\">" + label + "</a><span class=\"contentstooltiptext\">Blue Bubbles indicate the data source used by this example.</span></div>" //StyleChange
                }
                datasourceText += "</div>"
            }
            ...
            if (typeof showcaseSettings.technology != "undefined") {
                technologyText = '<div style="width: 218px; display: block; clear: both;"  style="padding-top: 10px;">' //StyleChange
            ...
            var listyle = "width: 218px; height: 260px;"
            let h3Name = showcaseSettings.name;
            if (h3Name.length > 53) {
                h3Name = h3Name.substr(0, 50) + "..."
            }
            if (forSearchBuilder == true)
                listyle = "width: 218px; height: 320px;"
            myElement = $('<li class="showcaseItemTile" data-showcaseid="' + showcaseSettings.id + '" id="' + showcaseName + '" style="' + listyle + '"></li>').append($("<div class=\"contentstile\"></div>").append(
