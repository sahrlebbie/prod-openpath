...
define(['underscore', 'components/controls/Messages'], function(_, Messages) {
    return function() {
        /**
        ...
        function Modal(id, options) {
            ...
            this.$el = $('<div>').addClass('modal').attr('id', modalId).append($('<div>').addClass('modal-dialog').append($('<div>').addClass('modal-content').append(header.append(headerCloseButton, this.title), this.body, this.footer)));
