...
// modified loader to allow the plugin to be loaded with RequireJS and other AMD environments without needing a "Highcharts" global
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define('highcharts-amd', [], function() {
            return factory(root);
        });
    }
