...
function ShowOutputsModal() {
    ...
    require([
        "jquery", Splunk.util.make_full_url('/static/app/Splunk_Security_Essentials/components/controls/Modal.js')
    ], function($, Modal) {
                    ...
                    allDocItems.forEach(function(guide) {
                        if (guide['id'] == step) {
                            ...
                            $(guide['short-description']).find("a").each(function(num, obj) {
                                if (typeof $(obj).attr("href") != "undefined" && $(obj).attr("href").indexOf("ttp") >= 0 && typeof $(obj).attr("noreferences") == "undefined") {
...
function triggerDocsRead(id) {
    ...
    if (typeof localStorage["sse-docs-" + id] == "undefined" || localStorage["sse-docs-" + id] != "complete") {
        buttonText = '<img style="height: 1.2em; width: 1.2em;" src="' + Splunk.util.make_full_url('/static/app/Splunk_Security_Essentials/images/general_images/ok_ico.gif') + '" /> Section Completed'
        $("#docsButton-" + id).html(buttonText)
            // console.log("Running it", buttonText)
        localStorage["sse-docs-" + id] = "complete"
        navCheckmark = '<img style="height: 1em; width: 1em;" src="' + Splunk.util.make_full_url('/static/app/Splunk_Security_Essentials/images/general_images/ok_ico.gif') + '" />&nbsp;'
                ...
                _.each(categories, function(category) {
                    ...
                    categoryFiltered.forEach(function(exampleInfo) {
                        ...
                        if (typeof localStorage["sse-docs-" + id] == "undefined" || localStorage["sse-docs-" + id] != "complete") {
                            ...
                            buttonText = '&nbsp;&nbsp;<button style="btn" id="docsButton-' + id + '" onclick=\'triggerDocsRead("' + id + '")\' ><img style="height: 1.2em; width: 1.2em;" src="' + Splunk.util.make_full_url('/static/app/Splunk_Security_Essentials/images/general_images/ok_ico.gif') + '" /> Section Completed</button>'
                            navCheckmark = '<img style="height: 1em; width: 1em;" src="' + Splunk.util.make_full_url('/static/app/Splunk_Security_Essentials/images/general_images/ok_ico.gif') + '" />&nbsp;'
                        }
                        ...
                        //var $exampleImg = $('<img />').attr('src', Splunk.util.make_url('/static/app/' + app +'/icons/' + (exampleInfo['description-icon'] || exampleInfo['id'] + ".png")));
                        var $exampleDescription = $('<div></div>').addClass("documentation").html(exampleInfo['short-description'].replace(/\%SSEDOCIMAGEPATH\%/g, Splunk.util.make_full_url("/static/app/Splunk_Security_Essentials/images/docimages")));
...
var allDocItems = [{
    ...
    },
    {
        ...
        "short-description": "<p>We weren't able to find that data source. This likely means that we haven't built out documentation for this data source yet. Please check the <a title=\"Splunkbase\" href=\"https://splunkbase.splunk.com/\">Splunkbase</a> page for the app.</p>\n",
        "category": ["System Configuration"]
    }
]
